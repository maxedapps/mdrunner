...
| T09 | T2.2: add read-only native Linux/macOS/Windows CI for fmt/clippy/tests/release help/version smoke without publication/browser invocation | T04,T07 | In progress | Workflow syntax/matrix/manual inspection and hosted checks when available | Run 29732047255: Linux/macOS/quality passed; Windows exposed two Unix-literal test fixtures. Parent made test-only platform-absolute expectations and reran fmt/35 tests/clippy locally; hosted rerun pending |
